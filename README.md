...
<ul>
   ...
   <li><strong>Expo CLI</strong> (není nutné globálně, používá se přes npx)<br />
   Spouští se pomocí: <code>npx expo start</code></li>
   <li>Mobilní zařízení s aplikací <strong>Expo Go</strong> verze 54.0.X (SDK 54) (Android/iOS) nebo Android/iOS emulátor</li>
</ul>

<h2>Doporučené prostředí</h2>
<ul> 
   <li>Operační systém: Windows 10/11, macOS, nebo Linux</li> 
   <li>Doporučená RAM: alespoň 8 GB</li> 
   <li>Stabilní připojení k internetu (pro stažení balíčků a běh Expo)</li> 
</ul> 
<h3>Volitelné (pro emulátor)</h3> 
<ul> 
   <li><strong>Android Studio</strong> – pokud chcete používat Android emulátor</li> 
   <li><strong>Xcode</strong> (pouze macOS) – pokud chcete používat iOS simulátor</li> 
</ul>
