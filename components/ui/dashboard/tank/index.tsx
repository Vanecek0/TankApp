        ...
        <View className={`${className} flex-col mx-5 p-5 rounded-xl`} style={{backgroundColor: Colors.primary}}>
            ...
            <View className="flex-row justify-between mt-3 mb-3">
                <View className="items-center">
                    ...
                    <ScaledText size="lg" style={{color: darkenHexColor(Colors.primary, -50)}} className=" font-bold">Výdaje za palivo</ScaledText>
                </View>
                <View className="items-center">
                    <ScaledText size="3xl" className="text-white font-bold mb-1">389 km</ScaledText>
                    <ScaledText size="lg" style={{color: darkenHexColor(Colors.primary, -50)}} className="font-bold">Vzdálenost</ScaledText>
                </View>
            </View>
