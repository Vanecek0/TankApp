    ...
    <>
      <View style={{ ...spacing.gap(12), ...spacing.mb(112) }} className='flex'>
        <View style={{ ...spacing.mt(8) }} className='flex-row flex-wrap justify-between'>
          <View style={{ backgroundColor: isDark ? Colors.background.surface.dark : Colors.background.surface.light, ...spacing.p(20), ...spacing.mb(12), ...spacing.borderRadius(8) }} className={`basis-[48.5%]`}>
          ...
          <View style={{ backgroundColor: isDark ? Colors.background.surface.dark : Colors.background.surface.light, ...spacing.p(20), ...spacing.borderRadius(8) }} className={`basis-[48.5%]`}>
            <View style={{ ...spacing.gap(4) }} className='flex-row items-center'>
